   ...
   public class classCancion
    {
        ...
        public bool proc_edita_cancion_prioridad(string strXmlDatos, int IdCancion)
        {
            ...
            return Verifica_Error(_objRetorno.Proc_Actualizar(xmlDatos, IdCancion, "musicalisimobd..sp_edita_cancion_prioridad", "Cancion", "@IdCancion"));
        }
        ...
        public bool proc_ingresa_cancion(string strXmlDatos)
        {
            XmlDocument xmlDatos = new XmlDocument();
            xmlDatos.LoadXml(strXmlDatos);
            return Verifica_Error(_objRetorno.Proc_Ingresar(xmlDatos, "musicalisimobd..sp_ingresa_cancion", "Cancion"));
        ...
        public bool proc_edita_cancion(string strXmlDatos, int IdCancion)
        {
            XmlDocument xmlDatos = new XmlDocument();
            xmlDatos.LoadXml(strXmlDatos);
            return Verifica_Error(_objRetorno.Proc_Actualizar(xmlDatos, IdCancion, "musicalisimobd..sp_edita_cancion", "Cancion", "@IdCancion"));
        }

        public bool proc_elimina_cancion(int IdCancion)
        {
            return Verifica_Error(_objRetorno.Proc_Eliminacion(IdCancion, "musicalisimobd..sp_elimina_cancion", "Cancion", "@IdCancion"));
