<%@ Page Language="C#" MasterPageFile="~/master/infoproductos.master" AutoEventWireup="true" CodeFile="cargarconsulta.aspx.cs" Inherits="cargarconsulta" %>
...
<asp:HiddenField ID="hfserv" runat="server" />
<asp:HiddenField ID="hfprodt" runat="server" />
<asp:HiddenField ID="hfitemspro" runat="server" />
<asp:HiddenField ID="hfitemsserv" runat="server" />
<div class="col-main span9">
<div class="padding-s">
<div class="page-title category-title">
<h1>Busqueda: <asp:Label ID="lbltitulo" runat="server" ></asp:Label></h1>
</div>
...
<h1><asp:Label ID="lblproductonombre" runat="server" ></asp:Label></h1>
</div>
<div id="productos_web" runat="server">

</div>
<div>
<h1><asp:Label ID="lblserviciosnombres" runat="server" ></asp:Label></h1>
</div>
