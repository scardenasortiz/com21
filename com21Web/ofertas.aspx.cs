...
public partial class ofertas : System.Web.UI.Page
{
    ...
    private void cargarnoticiasGrid(String inicio, String fin)
    {
        ...
        int j = 1;
                ...
                lblitems1.Text = Convert.ToString(_prod.Tables[1].Rows.Count);
                lblitems.Text = Convert.ToString(_prod.Tables[1].Rows.Count);
                ...
                else
                {
                    ...
                    servicios_web.InnerHtml = "<div style=\"font-size:18px;\">No exiten ofertas actualmente.&nbsp;<a href=\"" + _url + "\"><img alt=\"\" src=\"images/imagenes/icons_variados_theme_negro/_refresh.png\" width=\"24\" height=\"24\" title=\"Cargar Productos\" /></a></div>";
                }
    }
