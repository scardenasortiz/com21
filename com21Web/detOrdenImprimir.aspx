<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/infoimprimir.master" CodeFile="detOrdenImprimir.aspx.cs" Inherits="detOrden" %>
...
<div class="padding-s">
<div style="text-align: right"><a href="#" class="printer"><asp:Image ID="imgBtn_print" runat="server" ImageUrl="~/images/print_carrito.png" Width="48px" Height="45px" ToolTip="Imprimir" /></a></div>
