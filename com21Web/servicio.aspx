<%@ Page Language="C#" MasterPageFile="~/master/infoproductos.master" AutoEventWireup="true" CodeFile="servicio.aspx.cs" Inherits="servicio" %>
...
<div class="padding-s">
<div id="lbltitulo" runat="server" class="page-title category-title">
...
<asp:Panel ID="pnlProgress" runat="server" Style="display: none; width: 200px; background-color: #E2E2E2; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;"
    ...
    <Triggers>
        <asp:AsyncPostBackTrigger ControlID="ddlselect" 
            ...
            <asp:AsyncPostBackTrigger ControlID="dtcategoria" 
            EventName="SelectedIndexChanged" />
...
<p class="block-subtitle">Categorías</p>
<dl id="narrow-by-list">
<%--<dt>Categorías</dt>--%>
<dd>
<ol>
<asp:DataList ID="dtcategoria" runat="server" 
        onselectedindexchanged="dtcategoria_SelectedIndexChanged">
<ItemTemplate>
<li>
<asp:HiddenField ID="hfmarca" runat="server" Value='<%# Eval("Id_Categoria") %>' />
<asp:HiddenField ID="hftitulo" runat="server" Value='<%# Eval("Categoria") %>' />
<asp:LinkButton ID="lbmarca" runat="server" ForeColor="#8A8989" CommandName="Select"><%# Eval("Categoria")%></asp:LinkButton>&nbsp;(<asp:Label ID="lblcantidadmarca" runat="server"
