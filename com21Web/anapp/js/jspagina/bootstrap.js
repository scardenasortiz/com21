...
[0].offsetWidth
    ...
    $(document).on('click.dropdown.data-api touchstart.dropdown.data-api', clearMenus).on('click.dropdown touchstart.dropdown.data-api', '.dropdown form', function (e) { e.stopPropagation() }).on('touchstart.dropdown.data-api', '.dropdown-menu', function (e) { e.stopPropagation() }).on('click.dropdown.data-api touchstart.dropdown.data-api', toggle, Dropdown.prototype.toggle).on('keydown.dropdown.data-api touchstart.dropdown.data-api', toggle + ', [role=menu]', Dropdown.prototype.keydown)
} (window.jQuery); !function ($) {
    ...
    Modal.prototype = { constructor: Modal, toggle: function () { return this[!this.isShown ? 'show' : 'hide']() }, show: function () {
...
+ this.selector + '[href="' + target + '"]'
    ...
    "use strict"; var Typeahead = function (element, options) {
        this.$element = $(element)
    ...
    Typeahead.prototype = { constructor: Typeahead, select: function () {
        ...
        return this.hide()
    }, updater: function (item) { return item }, show: function () {
    ...
    }, matcher: function (item) { return ~item.toLowerCase().indexOf(this.query.toLowerCase()) }, sorter: function (items) {
