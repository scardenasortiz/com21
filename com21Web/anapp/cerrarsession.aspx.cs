...
public partial class cerrarsession : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.Cookies["IdCom21App"] != null)
        {
            HttpCookie myCookie = new HttpCookie("IdCom21App");
            myCookie.Expires = DateTime.Now.AddDays(-1d);
            Response.Cookies.Add(myCookie);
        }
        if (Request.Cookies["UserCom21App"] != null)
        {
            HttpCookie myCookie = new HttpCookie("UserCom21App");
            myCookie.Expires = DateTime.Now.AddDays(-1d);
            Response.Cookies.Add(myCookie);
        }
        if (Request.Cookies["PassCom21App"] != null)
        {
            HttpCookie myCookie = new HttpCookie("PassCom21App");
            myCookie.Expires = DateTime.Now.AddDays(-1d);
            Response.Cookies.Add(myCookie);
        }
        if (Request.Cookies["EmailCom21App"] != null)
        {
            HttpCookie myCookie = new HttpCookie("EmailCom21App");
            myCookie.Expires = DateTime.Now.AddDays(-1d);
            Response.Cookies.Add(myCookie);
        }
