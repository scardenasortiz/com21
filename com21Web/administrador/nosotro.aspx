<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/AdCom21.master" CodeFile="nosotro.aspx.cs" Inherits="administrador_nosotro" %>
...
<script type="text/javascript" >
   ...
   <div class="demoarea" style="margin-left: 5px">
		...
		<div class="dragbox" id="item1" >
            ...
            <asp:HiddenField ID="IdNosotrosInfo" runat="server" />
                        ...
                        <td>
                            <asp:GridView ID="GvMV" runat="server" AllowPaging="True" 
                                ...
                                <Columns>
                                    <asp:TemplateField ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="VerEditar" runat="server" CommandName="Select" 
                                                Height="20px" ImageUrl="~/images/64_edit_page.png" style="margin:2px;" 
                                                ToolTip="Ver/Editar Nosotros" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <EditItemTemplate>
                                            <asp:HiddenField ID="Id_EmpresaInfo" runat="server" 
                                                Value='<%# Bind("Id_Empresa") %>' />
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:HiddenField ID="Id_EmpresaInfo" runat="server" 
                                    ...
                                    <asp:TemplateField HeaderText="Nosotros" ItemStyle-HorizontalAlign="Center">
                                       <%-- <EditItemTemplate>
                                            <asp:Label ID="Titulo" runat="server" Text='<%# Bind("Titulo") %>'></asp:Label>
                                        </EditItemTemplate>--%>
                                        <ItemTemplate>
                                    ...
                                    <%--<asp:TemplateField HeaderText="Descripción" ItemStyle-HorizontalAlign="Justify">
                                        <EditItemTemplate>
                                            <asp:Label ID="Informacion" runat="server" Text='<%# HttpUtility.HtmlDecode(Eval("Informacion").ToString()) %>'></asp:Label>
                                        </EditItemTemplate>
                                        <ItemTemplate>
