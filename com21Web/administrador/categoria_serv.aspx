<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/AdCom21.master" CodeFile="categoria_serv.aspx.cs" Inherits="administrador_categoria_serv" %>
...
<div id="DMensaje" class="mensajes" runat="server"></div>
                     ...
                     <tr>
                        ...
                        <td>
                            <asp:Image ID="img" runat="server" Height="75px" Width="75px" 
                                ImageUrl="~/images/SIN_IMAGEN_CATSUB.png" />
                                <br />
                            <asp:Label ID="Label1" runat="server" Text="Tamaño de la imagen ancho:300, alto:300" Font-Size="10px"></asp:Label>
                            <br />
                            <asp:Label ID="Label2" runat="server" Text="Formato de la imagen: jpg, png, gif, bmp" Font-Size="10px"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
		...
		<div class="dragbox" id="item4" >
			...
			<div class="dragbox-content" >
                ...
                <asp:Panel ID="PMensajeSi" runat="server" Visible="false">
<div id="DMensajeSi" class="mensajes" runat="server"></div>
</asp:Panel>
                <table style="width: 100%;">
                    <tr>
                        <td>
                       ...
                       <%-- Buscar: 
                            ...
                            <table style="width: 100%;">
                             ...
                             <ajaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" 
                                 runat="server" TargetControlID="txtbuscarcategoria" WatermarkCssClass="watermarked" 
                                 WatermarkText="Buscar categorias" />
                                 </td>
                    ...
                    <tr>
                        <td style=" padding:6px;">
                            <asp:GridView ID="GvCategoria" runat="server" AllowPaging="True" 
                                AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id_Categoria" 
                                EnableModelValidation="True" ForeColor="#333333" GridLines="None" 
                                onpageindexchanging="GvCategoria_PageIndexChanging"
                                onrowdeleting="GvCategoria_RowDeleting" 
                                onselectedindexchanged="GvCategoria_SelectedIndexChanged" Width="100%">
                                ...
                                ImageUrl="~/images/imagenes/icons_variados_theme_negro/64_refresh.png" style="margin:2px;" 
                                    ...
                                    <asp:TemplateField HeaderText="Categoria" ItemStyle-HorizontalAlign="Center">
                                        <EditItemTemplate>
                                    ...
                                    <asp:TemplateField ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="Eliminar" runat="server" CommandName="Delete" 
                                                ...
                                                ToolTip="Eliminar Categoria" OnClientClick="return confirm('Desea eliminar la categoria.');" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                </Columns>
                ...
                <asp:Panel ID="prono" runat="server">
                    <table cellspacing="0" cellpadding="4" border="0" id="ctl00_ContentPlaceHolder1_GvCategoria" style="color:#333333;width:100%;border-collapse:collapse;">
			<tbody><tr style="color:#333333;background-color:#ABCD43;font-weight:bold;">
				<th scope="col">Categoria</th><th scope="col">Fecha Ingreso</th><th scope="col">Publicada</th>
			</tr><tr style="color:Black;background-color:#EEEEEE;font-family:Helvetica;font-size:14px;">
				    <td align="left" colspan="3">
                    No existen categorias ingresadas                       
                                        </td>
			</tr>
		</tbody></table>
