<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/AdCom21.master" CodeFile="ofertas.aspx.cs" Inherits="administrador_ofertas" %>
                        ...
                        <td>
                            <asp:GridView ID="GvNoticias" runat="server" AllowPaging="True" 
                                ...
                                ImageUrl="~/images/imagenes/icons_variados_theme_negro/64_refresh.png" style="margin:2px;" 
                                                ToolTip="Cargar Ofertas" onclick="refresh_Click" />
                                       </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Ofertas" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td width="77">
                                    ...
                                    <asp:TemplateField ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="Eliminar" runat="server" CommandName="Delete" 
                                                ...
                                                ToolTip="Eliminar Oferta" OnClientClick="return confirm('Desea eliminar la oferta');" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                </Columns>
