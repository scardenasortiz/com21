<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/AdCom21.master" CodeFile="categoria.aspx.cs" Inherits="administrador_categoria" %>
                                    ...
                                    <asp:TemplateField ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="Eliminar" runat="server" CommandName="Delete" 
                                                ...
                                                ToolTip="Eliminar Categoria" OnClientClick="return confirm('Al eliminar la categoria, se eliminaran las sub-categorias.');" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                </Columns>
