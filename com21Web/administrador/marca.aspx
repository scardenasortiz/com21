<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/AdCom21.master" CodeFile="marca.aspx.cs" Inherits="administrador_marca" %>
                   ...
                   <%-- <tr>
                        ...
                        <td>
                            <asp:Image ID="img" runat="server" Height="64px" Width="64px" 
                                ImageUrl="~/images/SIN_IMAGEN_Mar.png" />
                                <br />
                            <asp:Label ID="Label1" runat="server" Text="Tamaño de la imagen ancho:194px, alto:70px" Font-Size="10px"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" 
                                Font-Italic="True" ForeColor="#333333" onclick="LinkButton1_Click">Visualizar</asp:LinkButton>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>--%>
                    ...
                    <tr>
                        <td style=" padding:6px;">
                            <asp:GridView ID="GvMarca" runat="server" AllowPaging="True" 
                                ...
                                onselectedindexchanged="GvMarca_SelectedIndexChanged" Width="100%">
