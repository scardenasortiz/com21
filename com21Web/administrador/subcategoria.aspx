<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/AdCom21.master" CodeFile="subcategoria.aspx.cs" Inherits="administrador_subcategoria" %>
   ...
   <div class="demoarea" style="margin-left: 5px">
		...
		<div class="dragbox" id="item1" >
            ...
            <asp:HiddenField ID="hfletra" runat="server" />
                <asp:HiddenField ID="hfIdscategoria" runat="server" />
		...
		<div class="dragbox" id="item4" >
			<h2>Sub-Categorias Ingresadas</h2>
			<div class="dragbox-content" >
                ...
                <table style="width: 100%;">
                            ...
                            <table style="width: 100%;">
                             <tr>
                                 <td style="text-align: right">
                                      <asp:TextBox ID="txtbuscarsubcategoria" runat="server"
                             ...
                             <ajaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" 
                                 runat="server" TargetControlID="txtbuscarsubcategoria" WatermarkCssClass="watermarked" 
                                 WatermarkText="Buscar sub-categorias" />
                                 </td>
                    ...
                    <tr>
                        <td style=" padding:6px;">
                            <asp:GridView ID="GvSubCategoria" runat="server" AllowPaging="True" 
                                AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id_SubCategoria" 
                                EnableModelValidation="True" ForeColor="#333333" GridLines="None" 
                                onpageindexchanging="GvSubCategoria_PageIndexChanging"
                                onrowdeleting="GvSubCategoria_RowDeleting" 
                                onselectedindexchanged="GvSubCategoria_SelectedIndexChanged" Width="100%">
                                ...
                                ImageUrl="~/images/imagenes/icons_variados_theme_negro/64_refresh.png" style="margin:2px;" 
                                                ToolTip="Cargar Sub-categorias" onclick="refresh_Click" />
                                       </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:ImageButton ID="VerEditar" runat="server" CommandName="Select" 
                                                ...
                                                ToolTip="Ver/Editar Sub-Categoria" />
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Sub-Categoria" ItemStyle-HorizontalAlign="Center">
                                        <EditItemTemplate>
                ...
                <asp:Panel ID="prono" runat="server">
                    No existen sub-categorias ingresadas
                </asp:Panel>
			</div>
		</div>
