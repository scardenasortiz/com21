<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/AdCom21.master" CodeFile="asignarproductosub.aspx.cs" Inherits="administrador_asignarproductosub" %>
...
<script type="text/javascript" >
   ...
   <div class="demoarea" style="margin-left: 5px">
		...
		<div class="dragbox" id="item1" >
			<h2>Asignar Categoria y Sub-Categoria</h2>
		...
		<div class="dragbox" id="item4" >
			<h2>Productos sin sub-categoria</h2>
			<div class="dragbox-content" >
                ...
                <asp:Panel ID="prono" runat="server">
                    No existen productos sin sub-categoria</asp:Panel>
			</div>
		</div>
	    </div>
    </div>
