<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/infoproductos.master" CodeFile="nosotros.aspx.cs" Inherits="nosotros" %>
...
<h1><asp:Label ID="lbltitulo" runat="server" Text="Nosotros"></asp:Label></h1>
</div> 
